...
const menuByRole = (role, user) => {
  ...
  const catalog = [...roleMenus, studentDocumentsItem, payrollItem, equipmentItem, { key: '/jobs', icon: <CloudServerOutlined />, label: <Link to="/jobs">Tác vụ nền</Link> }, ...Object.values(maps).flat(), ...common];
