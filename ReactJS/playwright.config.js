...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'npm run dev -- --host 127.0.0.1 --port 5175 --strictPort', url: 'http://127.0.0.1:5175', env: { API_PROXY_TARGET: 'http://127.0.0.1:8091', VITE_GOOGLE_CLIENT_ID: '' }, reuseExistingServer: false, timeout: 60000 },
  ],
});
