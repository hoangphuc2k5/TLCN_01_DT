...
const RESOURCES = [
  ...
  { key: 'online_payments', label: 'Thanh toán online' },
  { key: 'appointments', label: 'Hẹn với giáo viên' },
  { key: 'surveys', label: 'Khảo sát hài lòng' },
  { key: 'rewards', label: 'Khen thưởng - kỷ luật' },
  { key: 'admissions', label: 'Tuyển sinh' },
  { key: 'student_documents', label: 'Hồ sơ học sinh' },
  ...
  { key: 'lesson_plans', label: 'Giáo án' },
  { key: 'contact_books', label: 'Sổ liên lạc' },
  { key: 'class_activities', label: 'Sinh hoạt lớp' },
  { key: 'parent_meetings', label: 'Họp phụ huynh' },
  { key: 'clubs', label: 'Câu lạc bộ' },
  { key: 'retakes', label: 'Thi lại / học lại' },
...
const LEGACY_PERMISSION_MAP = {
  ...
  PAY_ONLINE: { resource: 'online_payments', actions: ['view', 'create'] },
  MANAGE_APPOINTMENTS: { resource: 'appointments', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  REQUEST_APPOINTMENTS: { resource: 'appointments', actions: ['view', 'create', 'update'] },
  SUBMIT_SURVEYS: { resource: 'surveys', actions: ['view', 'create'] },
  MANAGE_REWARDS: { resource: 'rewards', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_ADMISSIONS: { resource: 'admissions', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_DOCUMENTS: { resource: 'student_documents', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  ...
  MANAGE_ASSIGNMENTS: { resource: 'assignments', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_LESSON_PLANS: { resource: 'lesson_plans', actions: ['view', 'execute'] },
  AUTHOR_LESSON_PLANS: { resource: 'lesson_plans', actions: ['view', 'create', 'update', 'delete'] },
  SUBMIT_ASSIGNMENTS: { resource: 'assignments', actions: ['view', 'create'] },
  MANAGE_CONTACT_BOOKS: { resource: 'contact_books', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_CLASS_ACTIVITIES: { resource: 'class_activities', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_PARENT_MEETINGS: { resource: 'parent_meetings', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_CLUBS: { resource: 'clubs', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  MANAGE_RETAKES: { resource: 'retakes', actions: ['view', 'create', 'update', 'delete', 'execute'] },
  REGISTER_CLUBS: { resource: 'clubs', actions: ['view', 'create'] },
  REQUEST_RETAKES: { resource: 'retakes', actions: ['view', 'create'] },
