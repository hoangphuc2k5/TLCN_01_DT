...
const PERMISSIONS = {
  ...
  MANAGE_LESSON_PLANS: 'MANAGE_LESSON_PLANS',
  AUTHOR_LESSON_PLANS: 'AUTHOR_LESSON_PLANS',
  SUBMIT_ASSIGNMENTS: 'SUBMIT_ASSIGNMENTS',
  MANAGE_CONTACT_BOOKS: 'MANAGE_CONTACT_BOOKS',
  MANAGE_CLASS_ACTIVITIES: 'MANAGE_CLASS_ACTIVITIES',
  MANAGE_PARENT_MEETINGS: 'MANAGE_PARENT_MEETINGS',
  MANAGE_CLUBS: 'MANAGE_CLUBS',
  MANAGE_RETAKES: 'MANAGE_RETAKES',
  REGISTER_CLUBS: 'REGISTER_CLUBS',
  REQUEST_RETAKES: 'REQUEST_RETAKES',
...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.SCHOOL_ADMIN]: [
    ...
    PERMISSIONS.MANAGE_LESSON_PLANS,
    PERMISSIONS.MANAGE_CONTACT_BOOKS,
    PERMISSIONS.MANAGE_CLASS_ACTIVITIES,
    PERMISSIONS.MANAGE_PARENT_MEETINGS,
    PERMISSIONS.MANAGE_APPOINTMENTS,
    PERMISSIONS.MANAGE_REWARDS,
    PERMISSIONS.MANAGE_ADMISSIONS,
    PERMISSIONS.MANAGE_DOCUMENTS,
    PERMISSIONS.MANAGE_FACILITIES,
    PERMISSIONS.MANAGE_CLUBS,
    PERMISSIONS.MANAGE_RETAKES,
  ...
  [ROLES.SUBJECT_TEACHER]: [
    ...
    PERMISSIONS.MANAGE_FACILITIES,
    PERMISSIONS.MANAGE_ASSIGNMENTS,
    PERMISSIONS.AUTHOR_LESSON_PLANS,
    PERMISSIONS.MANAGE_CONTACT_BOOKS,
    PERMISSIONS.MANAGE_CLASS_ACTIVITIES,
    PERMISSIONS.MANAGE_PARENT_MEETINGS,
    PERMISSIONS.MANAGE_APPOINTMENTS,
  ...
  [ROLES.STUDENT]: [
    ...
    PERMISSIONS.REGISTER_CLUBS,
    PERMISSIONS.REQUEST_RETAKES,
    PERMISSIONS.PAY_ONLINE,
  ],
  [ROLES.PARENT]: [PERMISSIONS.VIEW_OWN_DATA, PERMISSIONS.MANAGE_LEAVE, PERMISSIONS.PAY_ONLINE, PERMISSIONS.REQUEST_APPOINTMENTS, PERMISSIONS.SUBMIT_SURVEYS],
};
