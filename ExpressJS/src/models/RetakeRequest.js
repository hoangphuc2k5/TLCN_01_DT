...
const schema = new mongoose.Schema({
  ...
  requestType: { type: String, enum: ['RETAKE_EXAM', 'REPEAT_COURSE'], default: 'RETAKE_EXAM' },
...
schema.index({ studentId: 1, subjectId: 1, academicYearId: 1, requestType: 1, status: 1 });
